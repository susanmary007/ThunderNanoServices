...
namespace Plugin {
    ...
    bool SmartScreen::Init(const std::string& audiosource, const bool enableKWD, const std::string& pathToInputFolder)
    {
        ...
        std::shared_ptr<alexaSmartScreenSDK::smartScreenClient::EqualizerRuntimeSetup> equalizerRuntimeSetup =
            std::make_shared<alexaSmartScreenSDK::smartScreenClient::EqualizerRuntimeSetup>(false);

        bool equalizerEnabled = false;
        if (equalizerConfiguration && equalizerConfiguration->isEnabled()) {
            equalizerEnabled = true;
            equalizerRuntimeSetup = std::make_shared<alexaSmartScreenSDK::smartScreenClient::EqualizerRuntimeSetup>();
            auto equalizerStorage = acsdkEqualizer::MiscDBEqualizerStorage::create(miscStorage);
            auto equalizerModeController = alexaSmartScreenSDK::sampleApp::SampleEqualizerModeController::create();
